...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${BASE}/categories/trending`,    lastModified: now, changeFrequency: 'weekly'  as const, priority: 0.9 },
    { url: `${BASE}/categories/student`,     lastModified: now, changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${BASE}/categories/budget`,      lastModified: now, changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${BASE}/categories/ai-tools`,    lastModified: now, changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${BASE}/blog`,                   lastModified: now, changeFrequency: 'weekly'  as const, priority: 0.7 },
    { url: `${BASE}/wishlist`,               lastModified: now, changeFrequency: 'yearly'  as const, priority: 0.3 },
  ...
  const allProducts = await import('@/lib/getProducts').then(m => m.getProducts()).catch(() => []);
